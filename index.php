...
<head>
    ...
    <title><?php echo $row10["web_name"]; ?> | Tous les types de produits</title>
...
<body>
    ...
    <div class="title-content">Les nouveaux produits</div>
    <div class="title2-content">Les nouveautés</div>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="product-pack" onclick='redrq<?php echo $row["id"]; ?>();'>
                ...
                <div class="product-prices">
                    <span class="old-price"><s><?php echo $row["old_price"]; ?>DT</s></span>
                    <span class="original-price"><?php echo $row["price"]; ?>DT</span>
                </div>
            </div>
