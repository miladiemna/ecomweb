...
<body>
    ...
    <?php  include("./sidebar.php"); ?>
        <div class="content-bar">
            ...
            echo "<div style='position: relative; margin-top: 15px;'> <h2 style='margin-right: 20px; font-size: 32px; font-weight: lighter;'>Menu Principal</h2> <div style='background-color: #2C3E50; color: white; position: absolute; top: 0; right: 20px; padding: 5px 15px; border-radius: 12px;'>" . date("d/m/Y") . "</div> </div>" ;
