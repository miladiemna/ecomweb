...
if($delete_check_director) {
    ...
    if ($row["admin_user"] === $_SESSION["admin_user"]) {
        ...
        <h1 style="text-align: center; margin-top: 100px;">?Voulez vous supprimer votre propre compte</h1>
        <h2 style="text-align: center; margin-top: 50px;">
            <a style="margin: 0 10px; color: white; background-color: #18BC9C; padding: 10px 15px; text-decoration: none;" href="director">Retour</a>
        </h2>
