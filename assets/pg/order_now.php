...
<body>
                ...
                <div class="container-form">
                    ...
                    if (isset($_POST["order_sub"])) {
                        ...
                        if (empty($fullname) || empty($phone) || empty($address) || empty($city)) {
                            echo "<div style='font-size: 20px; font-weight: bold; color: red; display: block;'>Veuillez remplir les cases vides</div>";
                        }
                        else {
                            ...
                            if ($conn->query($sql) === TRUE) {
                                ...
                                echo "<div style='font-size: 20px; font-weight: bold; color: red; display: block;'>Une erreur s'est produite/div>";
                            }
                        }
                    }

                    ?>
                    <span style="font-size: 20px; font-weight: bold;">Merci de remplir le formaulaire pour passer votre commande</span>
    ...
    <footer>
        <div class="title-footer">Copy rights</div>
    </footer>
</body>
</html>